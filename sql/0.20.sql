-- Добавление массива идентификатров категорий в представление сообщения
begin;
...
(m.flags & 240::bigint) >> 4 AS message_type,
...
update config set value='0.20' where key='db_version';
commit;
