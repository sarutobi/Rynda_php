...
alter table users owner to wwwrynda;
...
alter table meta owner to wwwrynda;
...
alter table groups owner to wwwrynda;
...
alter table ci_sessions owner to wwwrynda;

update config set value = '0.12' where key='db_version';
commit;
