...
var $form = $('#filterForm'), // Форма фильтра для списка
...
/**
 * Сбор параметров фильтрации с формы фильтра списка и получение массива элементов списка,
 * соответствующих этим параметрам.
 * 
...
function getListItems($form)
{
    ...
    return $.ajax('/ajax_forms/ajaxGetOrganizations', {data: filterVars,
                                                type: 'post',
                                                async: true,
                                                dataType: 'json',
...
$(function(){ // Готовность DOM
    ...
    $form.submit(function(e){
        ...
        var $ajaxLoading = $('img#filterResponseLoading'),
            $formSubmit = $('input#filterSubmit', $form);
                 ...
                 if(resp && resp.status == 'success') {
                     if(resp.data.length > 0) {
                         ...
                         if($('#paginationItemsPerPage', $pagination).val() > 0) {
                             ...
                             /** * @todo Переменные шаблона для постраничной навигации... */
                             var currentPageNum = $listPages.data('current-page'),
                             ...
                             if(totalPages > 1) {
                                 ...
                                 $listPages.fadeOut(250)
                                           .html($.tmpl('pagesTemplate', paginationVars))
                                           .fadeIn(250);
                             }
                         }
                         ...
                         $formMessage.html(LANG_ORGANIZATIONS_NOT_FOUND).fadeIn(250);
                     }
                     $list.fadeIn(250);
