                  ...
                  <div style="float:left;display:block;padding-left:0">
                    <div style="display:block;float:left">
                      ...
                      <div style="font-size:15px;font-weight:normal">
                          <?php echo formatTextTrimmed(strip_tags($message['text']), 300)?>
                      </div>
                      <div>
                        <div style="display:block;float:left"><font size="1" color="#818181">Дата: <?php echo date($this->config->item('comments_date_format'), $message['dateAdded'])?></font></div>
                        <div style="display:block;float:left"><font size="1" color="#818181"> | Автор: <?php echo $message['firstName'].' '.$message['lastName']?> </font></div>
                      </div>
                      <br>
                    </div>
