...
/**
 * Файл содержит шаблон представления для страницы просмотра сообщения
 * типа "предложение помощи".
 *
 * @copyright  Copyright (c) 2011 Звягинцев Л. aka Ahaenor
 * @link       /application/views/messagesDetailOffer.php
 * @version    0.1
 * @since      Файл доступен начиная с версии проекта 0.1
 * @license    http://creativecommons.org/licenses/by-nc-sa/3.0/
 */

$title = "Предложение помощи №{$message['id']}".($message['title'] ? ": {$message['title']}" : "");
?>
...
<!--                <img src="/images/incognito.png" alt="Инкогнито" />-->
                ...
                <?php foreach((array)$message['phones'] as $phone) {?>
                    <span class="phone-ico mr10"></span><?php echo formatPhone($phone);?><br />
                <?php }?>
