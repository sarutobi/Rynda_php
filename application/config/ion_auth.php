 ...
 */
$config['site_title'] = 'Rynda.org'; // Site Title, example.com
$config['admin_email'] = 'support@rynda.org'; // Admin Email, admin@example.com
...
$config['user_expire'] = 1209600; // How long to remember the user (seconds)
 ...
 */
//$config['columns'] = array('first_name', 'last_name', 'phones', 'flags', 'ref_type',
//                           'about_me', 'my_photo', 'gender', 'birthday',);
 ...
 */
$config['email_forgot_password'] = 'forgotPassword.php';
 ...
 */
$config['email_forgot_password_complete'] = 'newPassword.php';
